...
interactive, step-by-step manner. A convenience class called ``PSAIdentifier``
is provided in ``pair_id.py``, which provides an intuitive interface to extract
data generated by PSA; the Jupyter notebook called
